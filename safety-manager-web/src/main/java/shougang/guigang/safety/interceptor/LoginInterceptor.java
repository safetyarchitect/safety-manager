package shougang.guigang.safety.interceptor;
...
import shougang.guigang.safety.login.service.UserService;
...
public class LoginInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (basicpersonnelinformation == null) {
			response.sendRedirect(SSO_LOGIN_URL + "?flag=true&redirectURL=" + request.getRequestURL());
			return false;
		}
		return true;
	}
